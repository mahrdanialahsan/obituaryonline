                                ...
                                <div class="elementor-widget-container">
                                    ...
                                    <section class="case-style-two sec-pad">
                                        <div class="pattern-layer"><br><br>
                                            <div class="pattern-1" style="background-image: url(images/shape-33.png);"></div>
                                            <div class="pattern-2" style="background-image: url(images/shape-34.png);"></div>
                                        </div>
                                        <figure class="icon-layer"><img decoding="async" src="images/heart-6.png" alt=""></figure>
                                        <div class="auto-container">
                                            <div class="title-inner">
                                                <div class="row align-items-center clearfix">
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-sm-12 text-column">
                                                        <div class="text">
                                                            <p>Ever undertakes laborious physical exercise except obtain some advantage from it but who has any right to find.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="case-block-two">
                                                    <div class="inner-box">
                                                        ...
                                                        <div class="lower-content">
                                                            <div class="text">
                                                                <div class="category">Our Causes</div>
                                                                <h3><a href="#">{{$campaign->deceased_name}}</a></h3>
