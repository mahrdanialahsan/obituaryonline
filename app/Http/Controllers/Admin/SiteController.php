...
//        dd($request->all());
        ...
        $site->my_campaigns_title                   =   $request->my_campaigns_title;
        ...
        $site->home_page_campaign_slider_title      =   $request->home_page_campaign_slider_title;
        ...
        $site->fundraise_page_menu_title            =   $request->fundraise_page_menu_title;
        $site->fundraise_page_header_title          =   $request->fundraise_page_header_title;
        $site->fundraise_page_campaign_title        =   $request->fundraise_page_campaign_title;
        $site->fundraise_page_form_title            =   $request->fundraise_page_form_title;
        ...
        if($request->hasFile('fundraise_page_cover_image')){
            $fileName          =   'fundraise_page_cover_image_' . time() . '.'. $request->fundraise_page_cover_image->extension();
            $request->fundraise_page_cover_image->move(storage_path('app/public/site_settings'), $fileName);
            $site->fundraise_page_cover_image     =  $fileName;
        }
